...
void test_submodule_modify__edit_and_save(void)
{
	...
	cl_assert_equal_i(
		GIT_SUBMODULE_UPDATE_REBASE, git_submodule_get_update(sm1));
	cl_assert_equal_i(
	...
	cl_assert_equal_i((int)old_update, (int)git_submodule_get_update(sm1));
	cl_assert_equal_i(
	...
	cl_assert_equal_i(
		(int)GIT_SUBMODULE_UPDATE_REBASE, (int)git_submodule_get_update(sm1));
	...
	cl_assert_equal_i(
		GIT_SUBMODULE_UPDATE_REBASE, git_submodule_get_update(sm2));
	cl_assert_equal_i(
